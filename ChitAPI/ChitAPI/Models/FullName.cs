...
namespace ChitAPI.Models
{
    ...
    public class FullName
    {
        ...
        [Required]
        //[RegularExpression("^[a-zA-Z]{5,200}$", ErrorMessage = "First Name Should be in alphabets within the range of 5,25")]

        public required string FirstName { get; set; }
        [Column("LastName", TypeName = "varchar(100)")]
        [Required]
       // [RegularExpression("^[a-zA-Z]{5,200}$", ErrorMessage = "Last Name Should be in alphabets within the range of 5,25")]
